...
import deskera.fintech.camt053.AccountStatement2;
import deskera.fintech.camt053.GroupHeader42;
...
public class BankToCustomerStatementV02 {
    ...
    protected deskera.fintech.camt053.GroupHeader42 grpHdr;
    @XmlElement(name = "Stmt", required = true)
    protected List<deskera.fintech.camt053.AccountStatement2> stmt;
     ...
     * @return
     *     possible object is
     *     {@link deskera.fintech.camt053.GroupHeader42 }
     *     
     */
    public deskera.fintech.camt053.GroupHeader42 getGrpHdr() {
        return grpHdr;
    }
     ...
     * {@link deskera.fintech.camt053.AccountStatement2 }
     * 
     * 
     */
    public List<deskera.fintech.camt053.AccountStatement2> getStmt() {
        if (stmt == null) {
